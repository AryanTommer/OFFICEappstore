...
from TechKiteOFFICEappstore.api.v1.release.importer import AppImporter
from TechKiteOFFICEappstore.api.v1.release.provider import AppReleaseProvider
from TechKiteOFFICEappstore.api.v1.serializers import AppSerializer, \
    AppReleaseDownloadSerializer, CategorySerializer, AppRatingSerializer, \
    AppRegisterSerializer, TechKiteOFFICEReleaseSerializer
from TechKiteOFFICEappstore.certificate.validator import CertificateValidator
from TechKiteOFFICEappstore.core.facades import read_file_contents
from TechKiteOFFICEappstore.core.models import App, AppRelease, Category, \
    AppRating, TechKiteOFFICERelease
from TechKiteOFFICEappstore.core.permissions import UpdateDeletePermission
from TechKiteOFFICEappstore.core.throttling import PostThrottle
from TechKiteOFFICEappstore.core.versioning import version_in_spec
from TechKiteOFFICEappstore.user.facades import update_token
...
class TechKiteOFFICEReleaseView(ListAPIView):
    queryset = TechKiteOFFICERelease.objects.all()
    serializer_class = TechKiteOFFICEReleaseSerializer
...
class AppView(DestroyAPIView):
    ...
    def _filter_releases(self, data, version):
        ...
        :param version: the TechKiteOFFICE version that we filter
...
class AppRegisterView(APIView):
    ...
    def post(self, request):
        ...
        chain = read_file_contents(settings.TechKiteOFFICE_CERTIFICATE_LOCATION)
        crl = read_file_contents(settings.TechKiteOFFICE_CRL_LOCATION)
