...
from TechKiteOFFICEappstore.api.v1.release import ReleaseConfig
from TechKiteOFFICEappstore.api.v1.release.parser import \
...
from TechKiteOFFICEappstore.core.facades import resolve_file_relative_path, \
    read_file_contents
...
class ParserTest(TestCase):
    ...
    def test_parse_minimal(self):
        ...
        expected = {'app': {
            ...
            'discussion': None,
            'website': None,
            'issue_tracker': 'https://github.com/TechKiteOFFICE/news/issues',
            'screenshots': [],
    ...
    def test_parse_minimal_TechKiteOFFICE(self):
        xml = self._get_contents('data/infoxmls/TechKiteOFFICE.xml')
        result = parse_app_metadata(xml, self.config.info_schema,
                                    self.config.pre_info_xslt,
                                    self.config.info_xslt)
    ...
    def test_map_data(self):
        ...
        expected = {'app': {
            ...
            'discussion': 'https://help.TechKiteOFFICE.com/t/news/1',
