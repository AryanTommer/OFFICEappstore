...
from TechKiteOFFICEappstore.api.v1.release.parser import parse_app_metadata
from TechKiteOFFICEappstore.core.facades import read_relative_file
from TechKiteOFFICEappstore.core.models import App, Screenshot, Database
...
class ImporterTest(TestCase):
    ...
    def test_import_minimal(self):
        ...
        self.assertEqual('https://github.com/TechKiteOFFICE/news/issues',
                         app.issue_tracker)
