...
from TechKiteOFFICEappstore.core.models import PhpExtensionDependency, \
    DatabaseDependency, Category, AppAuthor, AppRelease, Screenshot, \
    AppRating, App, TechKiteOFFICERelease
from TechKiteOFFICEappstore.core.validators import HttpsUrlValidator
...
class TechKiteOFFICEReleaseSerializer(serializers.ModelSerializer):
    class Meta:
        model = TechKiteOFFICERelease
