...
from TechKiteOFFICEappstore.api.v1.views import AppView, AppReleaseView, \
    CategoryView, SessionObtainAuthToken, RegenerateAuthToken, AppRatingView, \
    AppRegisterView, TechKiteOFFICEReleaseView, AppsView
from TechKiteOFFICEappstore.core.caching import app_ratings_etag, categories_etag, \
    apps_etag, TechKiteOFFICE_release_etag, apps_all_etag
from TechKiteOFFICEappstore.core.versioning import SEMVER_REGEX

app_name = 'v1'

urlpatterns = [
    url(r'^platforms\.json$',
        etag(TechKiteOFFICE_release_etag)(TechKiteOFFICEReleaseView.as_view()),
        name='platforms'),
