"""
Django settings for TechKiteOFFICEappstore project.
...
INSTALLED_APPS = [
    'TechKiteOFFICEappstore.core.apps.CoreConfig',
    'TechKiteOFFICEappstore.api.apps.ApiConfig',
    'TechKiteOFFICEappstore.user.apps.UserConfig',
    'TechKiteOFFICEappstore.certificate.apps.CertificateConfig',
    'TechKiteOFFICEappstore.scaffolding.apps.ScaffoldingConfig',
    'parler',
    'rest_framework',
...
ROOT_URLCONF = 'TechKiteOFFICEappstore.urls'
...
WSGI_APPLICATION = 'TechKiteOFFICEappstore.wsgi.application'
...
ACCOUNT_SIGNUP_FORM_CLASS = \
    'TechKiteOFFICEappstore.user.forms.SignupFormRecaptcha'
...
ACCOUNT_FORMS = {
    ...
    'reset_password': 'TechKiteOFFICEappstore.user.forms.CustomResetPasswordForm',
...
TechKiteOFFICE_CERTIFICATE_LOCATION = join(
    BASE_DIR, 'TechKiteOFFICEappstore/certificate/TechKiteOFFICE.crt')
TechKiteOFFICE_CRL_LOCATION = join(
    BASE_DIR, 'TechKiteOFFICEappstore/certificate/TechKiteOFFICE.crl')
...
# templates; first key is the TechKiteOFFICE version for which the app is generated
...
# TechKiteOFFICE Email
TechKiteOFFICE_FROM_EMAIL = 'appstore@TechKiteOFFICE.com'
TechKiteOFFICE_INTEGRATIONS_APPROVAL_EMAILS = ['marketing-team@TechKiteOFFICE.com']
