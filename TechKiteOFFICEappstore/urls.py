...
from TechKiteOFFICEappstore.core.caching import app_rating_etag
from TechKiteOFFICEappstore.core.feeds import AppReleaseAtomFeed, AppReleaseRssFeed
from TechKiteOFFICEappstore.core.views import CategoryAppListView, AppDetailView, \
    app_description, AppReleasesView, AppUploadView, AppRatingApi, \
    AppRegisterView
from TechKiteOFFICEappstore.scaffolding.views import AppScaffoldingView, \
...
urlpatterns = [
    ...
    url(r'^api/', include('TechKiteOFFICEappstore.api.urls',
                          namespace='api')),
    url(r'^account/',
        include('TechKiteOFFICEappstore.user.urls', namespace='user')),
