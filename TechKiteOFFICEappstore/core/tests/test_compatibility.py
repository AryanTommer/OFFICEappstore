...
from TechKiteOFFICEappstore.core.models import App, AppRelease, TechKiteOFFICERelease
...
class CompatibilityTest(TestCase):
    ...
    def test_compatible_apps_deduplication(self):
        ...
        AppRelease.objects.create(app=self.app1, version='3.0.0',
                                  platform_version_spec='>=10.0.0,<11.0.0')
        TechKiteOFFICERelease.objects.create(version='9.0.0')
        TechKiteOFFICERelease.objects.create(version='9.0.1')
        TechKiteOFFICERelease.objects.create(version='9.0.2')
        TechKiteOFFICERelease.objects.create(version='10.0.0')
    ...
    def test_compatible_releases_by_platform_v(self):
        self._create_example_releases()
        self._create_TechKiteOFFICE_versions()
    ...
    def _create_TechKiteOFFICE_versions(self):
        for version in self.platform_versions:
            TechKiteOFFICERelease.objects.create(version=version)
