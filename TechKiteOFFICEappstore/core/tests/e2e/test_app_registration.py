from TechKiteOFFICEappstore.core.facades import resolve_file_relative_path, \
    read_relative_file
from TechKiteOFFICEappstore.core.models import App
from TechKiteOFFICEappstore.core.tests.e2e import TEST_APP_SIG
...
class AppRegistrationTest(BaseStoreTest, AppDevSteps):
    ...
    def test_invalid_cert(self):
        ...
        with self.settings(
            ...
            TechKiteOFFICE_CERTIFICATE_LOCATION=self.cert_path('ca.crt'),
            TechKiteOFFICE_CRL_LOCATION=self.cert_path('ca.crl')
        ):
