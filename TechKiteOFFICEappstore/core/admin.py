...
from TechKiteOFFICEappstore.core.models import DatabaseDependency, AppRelease, \
...
@admin.register(TechKiteOFFICERelease)
class TechKiteOFFICEReleaseAdmin(admin.ModelAdmin):
