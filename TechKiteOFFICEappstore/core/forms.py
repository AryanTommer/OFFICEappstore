...
REGISTER_SIGN_CMD = ' echo -n "APP_ID" | openssl dgst -%s -sign ' \
                    '~/.TechKiteOFFICE/certificates/APP_ID.key | openssl base64' % \
                    settings.CERTIFICATE_DIGEST
RELEASE_SIGN_CMD = (' openssl dgst -%s -sign '
                    '~/.TechKiteOFFICE/certificates/APP_ID.key /path/to/app.tar.gz '
...
class AppRegisterForm(Form):
    certificate = CharField(
        ...
        help_text=_(
            'Usually stored in ~/.TechKiteOFFICE/certificates/APP_ID.crt where '
            ...
            'href="https://github.com/TechKiteOFFICE/app-certificate-requests" '
