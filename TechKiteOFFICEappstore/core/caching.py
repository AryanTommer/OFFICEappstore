...
from TechKiteOFFICEappstore.core.models import App, AppReleaseDeleteLog, Category, \
...
def TechKiteOFFICE_release_etag(request: Any) -> str:
    releases = [Version(rel.version) for rel in TechKiteOFFICERelease.objects.all()]
