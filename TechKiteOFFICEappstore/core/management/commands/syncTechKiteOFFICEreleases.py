...
from TechKiteOFFICEappstore.core.github import get_supported_releases, \
    GitHubClient, sync_releases


class Command(BaseCommand):
    help = 'Queries TechKiteOFFICE\'s GitHub releases API to update all locally ' \
           'stored TechKiteOFFICE versions'
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--oldest-supported', required=True,
                            help='Oldest supported TechKiteOFFICE version')
