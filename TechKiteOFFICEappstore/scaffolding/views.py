...
from TechKiteOFFICEappstore.core.models import App, Screenshot, TechKiteOFFICERelease
from TechKiteOFFICEappstore.scaffolding.archive import build_archive
from TechKiteOFFICEappstore.scaffolding.forms import AppScaffoldingForm, \
...
class AppScaffoldingView(FormView):
    ...
    def get_initial(self):
        init = {
            'platform': TechKiteOFFICERelease.get_current_main(),
            'categories': ('tools',)
        }
